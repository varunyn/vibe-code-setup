# Persona-Based Lab Selection

## Introduction

Use this page to choose the lab that best matches what you want to build or learn. Each card explains the kind of project, technology focus, and outcome so you can pick a starting point even if you have not seen the lab content before.
...
- Review the available workshop labs
